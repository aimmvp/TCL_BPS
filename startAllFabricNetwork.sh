...
#echo "CA IMAGES TAG : " ${CA_TAG}
#echo "FABRIC PEER, ORDERER IMAGES TAG : " ${FABRIC_TAG}
#echo "KAFKA ZOOKEEPER IMAGES TAG : " ${KZ_TAG}
#echo "COUCHDB IMAGE TAGE : " ${COUCHDB_TAG}
...
#	./run-couchdb.sh $COUCHDB_TAG couch3 5934 qa-test-net x86_64-1.0.3
#	./run-couchdb.sh $COUCHDB_TAG couch4 5944 qa-test-net x86_64-1.0.3
        ...
        ./run-couchdb.sh $COUCHDB_TAG couch7 5974 qa-test-net x86_64-1.0.3
        ./run-couchdb.sh $COUCHDB_TAG couch8 5984 qa-test-net x86_64-1.0.3
}
...
#	./run-peer.sh $FABRIC_TAG peer3 7071 org1 org1 couch3 false peer1 true qa-test-net
#	./run-peer.sh $FABRIC_TAG peer4 7081 org1 org1 couch4 false peer1 true qa-test-net
        ...
        ./run-peer.sh $FABRIC_TAG peer7 8071 org3 org3 couch7 true peer7 true qa-test-net
        ./run-peer.sh $FABRIC_TAG peer8 8081 org3 org3 couch8 false peer7 true qa-test-net
}
